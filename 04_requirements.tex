...
\section{Electrical requirements}
    ...
    \subsection{Power rail}
        ...
        Power line is controlled and protected by Latchup-Current Limiter FPF2701MX placed on EPS board. Therefore additional latchup protection in not necessary in this design. However, this sensor will be not only one on PLD board and should have it's own power switch. PLD board is enabled and disabled by EPS on OBC command and the sensor should be enabled only during TID readout. With this in mind, the sensor design is immune to state-changes of the internal power supply and the dose is accumulated off-line.
