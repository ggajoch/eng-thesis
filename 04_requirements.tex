...
\section{PW-Sat2}
    ...
    \subsection{Primary mission}
        The primary mission of PW-Sat2 is to test the deorbit sail. It's purpose is to increase atmospheric drag and shorten satellite life. This method of deorbitation could be an easy way to reduce space debris on LEO. A render of PW-Sat2 with opened sail is on \ref{PW-Sat_render_sail}.
...
\section{Mechanical requirements}
    ...
    \subsection{Thermal cycles}
        ...
        As described in \cite{ECSS_Q_ST_70_04C} the sensor should pass thermal cycle tests: $100$ times from $- (100 \pm 5)$\si{\degreeCelsius} to $(100 \pm 5)$\si{\degreeCelsius} in a vacuum environment. Test procedure is shown on \ref{thermal_tests}.
